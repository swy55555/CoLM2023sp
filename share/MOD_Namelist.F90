...
MODULE MOD_Namelist
   ...
   CHARACTER(len=256) :: DEF_CASE_NAME = 'gridbased_era5_IGBP_CHINA'
...
! ===============================================================
      ...
      IF (p_is_master) THEN
         ...
         IF (.not. fexists) THEN
            write(*,*) 'History namelist file: ', trim(DEF_hist_vars_namelist), 'a does not exist.'
         ELSE
   ...
   SUBROUTINE sync_hist_vars (set_defaults)
      ...
      CALL sync_hist_vars_one (DEF_hist_vars%albsp       ,  set_defaults)
